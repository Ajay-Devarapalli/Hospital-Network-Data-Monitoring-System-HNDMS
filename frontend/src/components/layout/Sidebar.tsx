...
import {
  ...
  Pill, Package, Award, BarChart3, Settings, LogOut, Menu, ChevronRight, ShieldCheck
} from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  { label: 'Control Center', href: '/dashboard', icon: LayoutDashboard, roles: ['admin', 'doctor', 'nurse', 'receptionist', 'patient'] },
  { label: 'System Users', href: '/admin/patients', icon: Users, roles: ['admin', 'doctor', 'nurse', 'receptionist'] },
  ...
  { label: 'Performance Analytics', href: '/admin/analytics', icon: BarChart3, roles: ['admin'] },
  { label: 'System Users (Roles)', href: '/admin/role-management', icon: ShieldCheck, roles: ['admin'] },
      ...
      <div className="flex items-center justify-between p-4 border-b border-border">
        {!collapsed && (
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-gray-900 dark:text-white">HNDMS</span>
          </div>
        )}
        <button
